...
=======
    ...
    struct lock *lock_acquired_by_other_threads;           /**/

    struct list lock_needed_by_other_threads;     /*list of threads needing lock that current thread is holding*/
...
int thread_find_max_priority (struct thread *cur);
